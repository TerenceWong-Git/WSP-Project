...
async function importData() {
  ...
  // // Insert dummy data
  const products = [
    { product_category: 1, image: "/productImages/drinks/COKE.jpg", product_name: "Coke", product_price: "28", stock: true, salesQuantity: 11, brand: 1 },
    { product_category: 1, image: "/productImages/drinks/COKE_PLUS.jpg", product_name: "Coke Zero", product_price: "37", stock: true, salesQuantity: 22, brand: 1 },
    ...
    { product_category: 3, image: "/productImages/cupNoodles/ichiranTonkotsu.jpg", product_name: "Ichiran Tonkotsu", product_price: "66", stock: true, salesQuantity: 69, brand: 3 },
